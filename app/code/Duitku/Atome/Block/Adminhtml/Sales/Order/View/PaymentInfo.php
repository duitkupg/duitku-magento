<?php
/**
 * Copyright (c) 2017. All rights reserved Duitku Atomepayment.
 *
 ...
 *
 * @author    Duitku Atomepayment
 * @copyright Duitku Atomepayment (http://duitku.com)
 * @license   Duitku Atomepayment
 *
 */
namespace Duitku\Atome\Block\Adminhtml\Sales\Order\View;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
     ...
     * @param \Duitku\Atome\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\Atome\Helper\Data $duitkuHelper,
        array $data = []
    ) {
     ...
     *
     * @param \Duitku\Atome\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Atome\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
