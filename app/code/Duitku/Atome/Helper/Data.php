...
namespace Duitku\Atome\Helper;
include_once('Duitku/DuitkuCore.php');
use Duitku\Atome\Helper\DuitkuConstants;
use Duitku_Atome_Core;
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * @var \Duitku\Atome\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\Atome\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Atome\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_atomeepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Atome_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Atome")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Atome\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
