 ...
 *
 */
namespace Duitku\Atome\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Atome\Helper\DuitkuConstants;

class Payment extends \Duitku\Atome\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_atomeepay';
    const METHOD_REFERENCE = 'duitkuatomeReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Atome\Block\Info\View';
    ...
    /**
     * @var \Duitku\Atome\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Atome\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Atome\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_atomeepay/merchantnumber');
    ...
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epayatome/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epayatome/accept');
     ...
     * @return \Duitku\Atome\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayatome/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayatome/cancel', ['_secure' => $this->_request->isSecure()]);
    }
