 ...
 *
 */
namespace Duitku\BNC\Block\Adminhtml\Sales\Order\View;

use Duitku\BNC\Model\Method\Epay\Payment as EpayPayment;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\BNC\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\BNC\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\BNC\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
