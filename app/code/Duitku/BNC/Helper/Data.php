...
{
    /**
     * @var \Duitku\BNC\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\BNC\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\BNC\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_bncepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_BNC_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_BNC")['setup_version'];
    }
     ...
     *
     * @param \Duitku\BNC\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
