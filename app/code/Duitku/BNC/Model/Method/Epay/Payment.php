 ...
 *
 */
namespace Duitku\BNC\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\BNC\Helper\DuitkuConstants;

class Payment extends \Duitku\BNC\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_bncepay';
    const METHOD_REFERENCE = 'duitkubncReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\BNC\Block\Info\View';
    ...
    /**
     * @var \Duitku\BNC\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\BNC\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\BNC\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_bncepay/merchantnumber');
   	$apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_bncepay/api_key');
    $amount = round($order->getBaseTotalDue());
    
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epaybnc/callback');
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epaybnc/accept');
     ...
     * @return \Duitku\BNC\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaybnc/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaybnc/cancel', ['_secure' => $this->_request->isSecure()]);
    }
