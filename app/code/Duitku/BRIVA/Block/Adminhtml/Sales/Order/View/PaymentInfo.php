 ...
 *
 */
namespace Duitku\BRIVA\Block\Adminhtml\Sales\Order\View;

use Duitku\BRIVA\Model\Method\Epay\Payment as EpayPayment;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
     ...
     * @param \Duitku\BRIVA\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\BRIVA\Helper\Data $duitkuHelper,
        array $data = []
    ) {
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\BRIVA\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\BRIVA\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\BRIVA\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
