 ...
 *
 */
namespace Duitku\BRIVA\Controller\Epaybriva;
use Magento\Framework\Controller\ResultFactory;

class Checkout extends \Duitku\BRIVA\Controller\AbstractActionController
{
    /**
     * Checkout Action
     */
    public function execute()
    {
    	 ...
    	 $paymentmode = $this->_scopeConfig->getValue('payment/duitku_brivaepay/payment_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    	 if($paymentmode =='1')
    	 {
        ...
        $result = $this->getEPayPaymentWindowRequest($order);
       	$helper = $obj->get('Duitku\BRIVA\Helper\Data');
