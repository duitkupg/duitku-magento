...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->getConfigData($field, 'duitku_brivaepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_BRIVA_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_BRIVA")['setup_version'];
    }
     ...
     *
     * @param \Duitku\BRIVA\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
