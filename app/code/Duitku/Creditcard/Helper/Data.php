...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->getConfigData($field, 'duitku_epay', $storeId);
    }
		
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Creditcard_Core();
		return $DuitkuCore;
	}
    /**
     * Gives back duitku_checkout configuration values
    ...
    {
        return $this->_moduleList->getOne("Duitku_Creditcard")['setup_version'];
    }
