 ...
 *
 */
namespace Duitku\Creditcard\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Creditcard\Helper\DuitkuConstants;

class Payment extends \Duitku\Creditcard\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_epay';
    const METHOD_REFERENCE = 'duitkuReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Creditcard\Block\Info\View';
    ...
    /**
     * @var \Duitku\Creditcard\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Creditcard\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Creditcard\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_epay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epay/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epay/cancel', ['_secure' => $this->_request->isSecure()]);
    }
