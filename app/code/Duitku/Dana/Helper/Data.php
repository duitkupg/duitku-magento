...
{
    /**
     * @var \Duitku\Dana\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\Dana\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\Dana\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_danaepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Dana_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_Dana")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Dana\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
