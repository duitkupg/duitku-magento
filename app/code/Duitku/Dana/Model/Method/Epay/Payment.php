 ...
 *
 */
namespace Duitku\Dana\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Dana\Helper\DuitkuConstants;

class Payment extends \Duitku\Dana\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_danaepay';
    const METHOD_REFERENCE = 'duitkudanaReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Dana\Block\Info\View';
    ...
    /**
     * @var \Duitku\Dana\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Dana\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Dana\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_danaepay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
   	$apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_danaepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
    $amount = round($order->getBaseTotalDue());
    
    $objectManager = \Magento\Framework\App\ObjectManager::getInstance(); 
    $FormKey = $objectManager->get('Magento\Framework\Data\Form\FormKey');
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epaydana/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epaydana/accept');
     ...
     * @return \Duitku\Dana\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaydana/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaydana/cancel', ['_secure' => $this->_request->isSecure()]);
    }
