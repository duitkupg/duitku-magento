...
namespace Duitku\GudangVoucherQris\Helper;
...
use Duitku_GudangVoucherQris_Core;
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * @var \Duitku\GudangVoucherQris\Logger\DuitkuLogger
     */
     ...
     * @param \Duitku\GudangVoucherQris\Logger\DuitkuLogger $duitkuLogger
     * @param \Magento\Framework\Encryption\EncryptorInterface $encryptor
     * @param \Magento\Framework\Module\ModuleListInterface $moduleList
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Duitku\GudangVoucherQris\Logger\DuitkuLogger $duitkuLogger,
    ...
    {
        return $this->getConfigData($field, 'duitku_gudangvoucherepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_GudangVoucherQris_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_GudangVoucherQris")['setup_version'];
    }
     ...
     *
     * @param \Duitku\GudangVoucherQris\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
