<?php
/**
 * Copyright (c) 2017. All rights reserved Duitku Indodanapayment.
 *
 ...
 *
 * @author    Duitku Indodanapayment
 * @copyright Duitku Indodanapayment (http://duitku.com)
 * @license   Duitku Indodanapayment
 *
 */
namespace Duitku\Indodana\Block\Adminhtml\Sales\Order\View;

use Duitku\Indodana\Model\Method\Epay\Payment as EpayPayment;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @var \Duitku\Indodana\Helper\Data
     */
     ...
     * @param \Duitku\Indodana\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\Indodana\Helper\Data $duitkuHelper,
        array $data = []
    ) {
     ...
     *
     * @param \Duitku\Indodana\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Indodana\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
