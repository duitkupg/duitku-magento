 ...
 *
 */
namespace Duitku\Indodana\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Indodana\Helper\DuitkuConstants;

class Payment extends \Duitku\Indodana\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_indodanaepay';
    const METHOD_REFERENCE = 'duitkuindodanaReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Indodana\Block\Info\View';
    ...
    /**
     * @var \Duitku\Indodana\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Indodana\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Indodana\Model\Api\Epay\Request\Payment
     */
     ...
     * @return \Duitku\Indodana\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayindodana/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayindodana/cancel', ['_secure' => $this->_request->isSecure()]);
    }
