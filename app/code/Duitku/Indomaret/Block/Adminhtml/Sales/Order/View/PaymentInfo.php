<?php
/**
 * Copyright (c) 2017. All rights reserved Duitku Indomaretpayment.
 *
 ...
 *
 * @author    Duitku Indomaretpayment
 * @copyright Duitku Indomaretpayment (http://duitku.com)
 * @license   Duitku Indomaretpayment
 *
 */
namespace Duitku\Indomaret\Block\Adminhtml\Sales\Order\View;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\Indomaret\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\Indomaret\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Indomaret\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
