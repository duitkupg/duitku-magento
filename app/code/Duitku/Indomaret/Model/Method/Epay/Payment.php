 ...
 *
 */
namespace Duitku\Indomaret\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Indomaret\Helper\DuitkuConstants;

class Payment extends \Duitku\Indomaret\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_indomaretepay';
    const METHOD_REFERENCE = 'duitkuindomaretReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Indomaret\Block\Info\View';
    ...
    /**
     * @var \Duitku\Indomaret\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Indomaret\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Indomaret\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_indomaretepay/merchantnumber');
   	$apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_indomaretepay/api_key');
    $amount = round($order->getBaseTotalDue());
    
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epayindomaret/callback');
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epayindomaret/accept');
     ...
     * @return \Duitku\Indomaret\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayindomaret/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayindomaret/cancel', ['_secure' => $this->_request->isSecure()]);
    }
