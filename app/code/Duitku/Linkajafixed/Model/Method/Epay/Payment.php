...
class Payment extends \Duitku\Linkajafixed\Model\Method\AbstractPayment
{
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajafixedepay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
  	 $apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajafixedepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
