...
class Payment extends \Duitku\Linkajapercent\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_linkajapercentepay';
    const METHOD_REFERENCE = 'duitkulinkajapercentReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Linkajapercent\Block\Info\View';
    ...
    /**
     * @var \Duitku\Linkajapercent\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Linkajapercent\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Linkajapercent\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajapercentepay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
  	 $apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajapercentepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
     ...
     * @return \Duitku\Linkajapercent\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaylinkajapercent/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaylinkajapercent/cancel', ['_secure' => $this->_request->isSecure()]);
    }
