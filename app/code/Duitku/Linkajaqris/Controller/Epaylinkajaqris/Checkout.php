...
class Checkout extends \Duitku\Linkajaqris\Controller\AbstractActionController
{
    /**
     * Checkout Action
     */
    public function execute()
    {
    	 ...
    	 $paymentmode = $this->_scopeConfig->getValue('payment/duitku_linkajaqrisepay/payment_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    	 if($paymentmode =='1')
    	 {
        ...
        $result = $this->getEPayPaymentWindowRequest($order);
          $helper = $obj->get('Duitku\Linkajaqris\Helper\Data');
