<?php
/**
 * Copyright (c) 2017. All rights reserved Duitku Nusapaypayment.
 *
 ...
 *
 * @author    Duitku Nusapaypayment
 * @copyright Duitku Nusapaypayment (http://duitku.com)
 * @license   Duitku Nusapaypayment
 *
 */
namespace Duitku\Nusapay\Block\Adminhtml\Sales\Order\View;

use Duitku\Nusapay\Model\Method\Epay\Payment as EpayPayment;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @var \Duitku\Nusapay\Helper\Data
     */
     ...
     * @param \Duitku\Nusapay\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\Nusapay\Helper\Data $duitkuHelper,
        array $data = []
    ) {
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\Nusapay\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\Nusapay\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Nusapay\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
