 ...
 *
 */
namespace Duitku\Nusapay\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Nusapay\Helper\DuitkuConstants;

class Payment extends \Duitku\Nusapay\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_nusapay';
    const METHOD_REFERENCE = 'duitkunusaReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Nusapay\Block\Info\View';
    ...
    /**
     * @var \Duitku\Nusapay\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Nusapay\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Nusapay\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_nusapay/merchantnumber');
   	$apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_nusapay/api_key');
	
    $amount = round($order->getBaseTotalDue());
    $objectManager = \Magento\Framework\App\ObjectManager::getInstance(); 
    $FormKey = $objectManager->get('Magento\Framework\Data\Form\FormKey');
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epaynusapay/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epaynusapay/accept');
     ...
     * @return \Duitku\Nusapay\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaynusapay/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaynusapay/cancel', ['_secure' => $this->_request->isSecure()]);
    }
