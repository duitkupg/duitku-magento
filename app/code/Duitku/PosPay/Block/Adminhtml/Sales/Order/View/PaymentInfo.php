 ...
 *
 */
namespace Duitku\PosPay\Block\Adminhtml\Sales\Order\View;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
     ...
     * @param \Duitku\PosPay\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\PosPay\Helper\Data $duitkuHelper,
        array $data = []
    ) {
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\PosPay\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\PosPay\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\PosPay\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
