...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->getConfigData($field, 'duitku_pospayepay', $storeId);
    }
	
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_PosPay_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_PosPay")['setup_version'];
    }
     ...
     *
     * @param \Duitku\PosPay\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
