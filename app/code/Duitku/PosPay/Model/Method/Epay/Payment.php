 ...
 *
 */
namespace Duitku\PosPay\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\PosPay\Helper\DuitkuConstants;

class Payment extends \Duitku\PosPay\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_pospayepay';
    const METHOD_REFERENCE = 'duitkupospayReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\PosPay\Block\Info\View';
    ...
    /**
     * @var \Duitku\PosPay\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\PosPay\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\PosPay\Model\Api\Epay\Request\Payment
     */
     ...
     * @return \Duitku\PosPay\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaypospay/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epaypospay/cancel', ['_secure' => $this->_request->isSecure()]);
    }
