...
*
*/
namespace Duitku\Shopeepay\Controller;

use \Magento\Sales\Model\Order;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Shopeepay\Helper\DuitkuConstants;
use \Duitku\Shopeepay\Model\Method\Epay\Payment as EpayPayment;
...
abstract class AbstractActionController extends \Magento\Framework\App\Action\Action implements \Magento\Framework\App\CsrfAwareActionInterface
{
	...
	*/
	...
	/**
	* @var \Duitku\Shopeepay\Helper\Data
	*/
	...
	*/
	...
	/**
	* @var \Duitku\Shopeepay\Logger\DuitkuLogger
	*/
	...
	* @param \Duitku\Shopeepay\Helper\Data $duitkuHelper
	* @param \Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory
	* @param \Duitku\Shopeepay\Logger\DuitkuLogger $duitkuLogger
	...
	*/
	public function __construct(
		...
		\Duitku\Shopeepay\Helper\Data $duitkuHelper,
		\Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory,
		\Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig,
		\Duitku\Shopeepay\Logger\DuitkuLogger $duitkuLogger,
	...
	* @param \Duitku\Shopeepay\Model\Method\AbstractPayment $paymentMethodInstance
	* @param string $txnId
