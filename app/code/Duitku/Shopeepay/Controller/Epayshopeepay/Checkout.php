...
class Checkout extends \Duitku\Shopeepay\Controller\AbstractActionController
{
    /**
     * Checkout Action
     */
    public function execute()
    {
    	 ...
    	 $paymentmode = $this->_scopeConfig->getValue('payment/duitku_shopeeepay/payment_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    	 if($paymentmode =='1')
    	 {
        ...
        $result = $this->getEPayPaymentWindowRequest($order);
       	$helper = $obj->get('Duitku\Shopeepay\Helper\Data');
