...
namespace Duitku\Shopeepay\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    {
        return $this->getConfigData($field, 'duitku_shopeepay', $storeId);
    }
    ...
    {
        return $this->_moduleList->getOne("Duitku_Shopeepay")['setup_version'];
    }
     ...
     *
     * @param \Duitku\Shopeepay\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
