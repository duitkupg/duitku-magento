 ...
 *
 */
namespace Duitku\Shopeepay\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Shopeepay\Helper\DuitkuConstants;

class Payment extends \Duitku\Shopeepay\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_shopeepay';
    const METHOD_REFERENCE = 'duitkushopeeReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Shopeepay\Block\Info\View';
    ...
    /**
     * @var \Duitku\Shopeepay\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Shopeepay\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Shopeepay\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_shopeepay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
   	$apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_shopeepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
     ...
     * @return \Duitku\Shopeepay\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayshopeepay/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayshopeepay/cancel', ['_secure' => $this->_request->isSecure()]);
    }
