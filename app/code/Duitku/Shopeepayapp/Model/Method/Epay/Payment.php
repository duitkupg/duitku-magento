...
class Payment extends \Duitku\Shopeepayapp\Model\Method\AbstractPayment
{
    ...
    protected $_infoBlockType = 'Duitku\Shopeepayapp\Block\Info\View';
    ...
    /**
     * @var \Duitku\Shopeepayapp\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Shopeepayapp\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Shopeepayapp\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_shopeepayapp/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
   	$apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_shopeepayapp/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
     ...
     * @return \Duitku\Shopeepayapp\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayshopeepayapp/checkout', ['_secure' => $this->_request->isSecure()]);
    }
