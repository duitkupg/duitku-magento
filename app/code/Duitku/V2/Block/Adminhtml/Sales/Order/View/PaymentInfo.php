 ...
 *
 */
namespace Duitku\V2\Block\Adminhtml\Sales\Order\View;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    protected function _toHtml()
    {
        ...
        // Check if current payment method is in the list of all registered methods
        if (in_array($method, MethodRegistry::getAllCodes(), true)) {
    ...
    public function getTransactionData()
    {
        ...
        // Check if current payment method is in the list of all registered methods
        if (in_array($paymentMethod, MethodRegistry::getAllCodes(), true)) {
            /** @var \Duitku\V2\Model\Method\Bniqris\Payment */
     ...
     *
     * @param \Duitku\V2\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\V2\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
