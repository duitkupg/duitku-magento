...
abstract class DuitkuController extends \Magento\Framework\App\Action\Action implements \Magento\Framework\App\CsrfAwareActionInterface
{
	/**
	...
	*/
	...
	/**
	* @var \Duitku\V2\Logger\DuitkuLogger
	*/
	...
	* @param \Duitku\V2\Helper\Data $duitkuHelper
	* @param \Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory
	* @param \Duitku\V2\Logger\DuitkuLogger $duitkuLogger
	...
	*/
	public function __construct(
		...
		\Duitku\V2\Helper\Data $duitkuHelper,
		\Magento\Framework\Controller\Result\JsonFactory $resultJsonFactory,
		\Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig,
		\Duitku\V2\Logger\DuitkuLogger $duitkuLogger,
...
//     }
	...
	*/
	protected function _logError($id,$paymentMethod,$errorMessage){
		$this->_duitkuLogger->addError($id,$paymentMethod, $errorMessage);
	}

	protected function _logInfo($id,$errorMessage){
		$this->_duitkuLogger->addEpayInfo($id,$errorMessage);
	}
