...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
     ...
     * @return mixed
     */
    public function getDuitkuSettingConfigData($field, $storeId = null)
    {
        return $this->getConfigData($field, 'duitku_setting', $storeId);
    }
	public function getDuitkuCore(){
   		$DuitkuCore = new Duitku_Core();
		return $DuitkuCore;
	}
    ...
    {
        return $this->_moduleList->getOne("Duitku_V2")['setup_version'];
    }
     ...
     *
     * @param \Duitku\V2\Model\Api\Checkout\Response\Base $request
     * @param mixed $id
