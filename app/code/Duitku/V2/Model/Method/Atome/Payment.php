...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Atome\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get atome Auth object
     *
     * @return \Duitku\V2\Model\Api\Atome\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Atome\Payment
     */
    ...
    /**
     * Create the atome payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Atome\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_atome/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Atome\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the atome Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the atome Decline action
     *
     * @return string
     */
