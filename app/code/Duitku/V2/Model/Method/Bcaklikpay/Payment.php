...
{
    const METHOD_CODE = 'duitku_bcaklikpay';
    const METHOD_REFERENCE = 'duitkuBcaklikpayReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Bcaklikpay\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get bcaklikpay Auth object
     *
     * @return \Duitku\V2\Model\Api\Bcaklikpay\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Bcaklikpay\Payment
     */
    ...
    /**
     * Create the bcaklikpay payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Bcaklikpay\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_bcaklikpay/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Bcaklikpay\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the bcaklikpay Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the bcaklikpay Decline action
     *
     * @return string
     */
