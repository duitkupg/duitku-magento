...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Bnc\Request\Models\Auth
     */
    protected $_auth;
     ...
     * Get bnc Auth object
     *
     * @return \Duitku\V2\Model\Api\Bnc\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Bnc\Payment
     */
    ...
    /**
     * Create the bnc payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Bnc\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_bnc/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Bnc\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the bnc Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the bnc Decline action
     *
     * @return string
     */
