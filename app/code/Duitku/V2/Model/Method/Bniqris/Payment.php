 ...
 *
 */
namespace Duitku\V2\Model\Method\Bniqris;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_bniqris';
    const METHOD_REFERENCE = 'duitkuBniqrisReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Bniqris\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get bniqris Auth object
     *
     * @return \Duitku\V2\Model\Api\Bniqris\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Bniqris\Payment
     */
    ...
    /**
     * Create the bniqris payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Bniqris\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_bniqris/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Bniqris\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the bniqris Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the bniqris Decline action
     *
     * @return string
     */
