...
{
    const METHOD_CODE = 'duitku_briva';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Briva\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get briva Auth object
     *
     * @return \Duitku\V2\Model\Api\Briva\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Briva\Payment
     */
    ...
    /**
     * Create the briva payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Briva\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_briva/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Briva\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the briva Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the briva Decline action
     *
     * @return string
     */
