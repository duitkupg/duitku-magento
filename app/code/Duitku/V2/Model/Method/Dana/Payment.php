...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Dana\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get dana Auth object
     *
     * @return \Duitku\V2\Model\Api\Dana\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Dana\Payment
     */
    ...
    /**
     * Create the dana payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Dana\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_dana/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Dana\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the dana Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the dana Decline action
     *
     * @return string
     */
