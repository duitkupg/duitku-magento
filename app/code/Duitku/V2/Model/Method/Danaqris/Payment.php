 ...
 *
 */
namespace Duitku\V2\Model\Method\Danaqris;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_danaqris';
    const METHOD_REFERENCE = 'duitkuDanaqrisReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Danaqris\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get danaqris Auth object
     *
     * @return \Duitku\V2\Model\Api\Danaqris\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Danaqris\Payment
     */
    ...
    /**
     * Create the danaqris payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Danaqris\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_danaqris/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Danaqris\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the danaqris Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the danaqris Decline action
     *
     * @return string
     */
