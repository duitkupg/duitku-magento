...
{
    const METHOD_CODE = 'duitku_gudangvoucherqris';
    const METHOD_REFERENCE = 'duitkuGudangvoucherqrisReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Gudangvoucherqris\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get gudangvoucherqris Auth object
     *
     * @return \Duitku\V2\Model\Api\Gudangvoucherqris\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Gudangvoucherqris\Payment
     */
    ...
    /**
     * Create the gudangvoucherqris payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Gudangvoucherqris\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_gudangvoucherqris/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Gudangvoucherqris\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the gudangvoucherqris Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the gudangvoucherqris Decline action
     *
     * @return string
     */
