...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Indodana\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get indodana Auth object
     *
     * @return \Duitku\V2\Model\Api\Indodana\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Indodana\Payment
     */
    ...
    /**
     * Create the indodana payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Indodana\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_indodana/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Indodana\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the indodana Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the indodana Decline action
     *
     * @return string
     */
