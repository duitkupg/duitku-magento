...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Indomaret\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get indomaret Auth object
     *
     * @return \Duitku\V2\Model\Api\Indomaret\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Indomaret\Payment
     */
    ...
    /**
     * Create the indomaret payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Indomaret\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_indomaret/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Indomaret\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the indomaret Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the indomaret Decline action
     *
     * @return string
     */
