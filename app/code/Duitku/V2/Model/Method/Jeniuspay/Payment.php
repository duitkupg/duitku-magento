...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Jeniuspay\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get jeniuspay Auth object
     *
     * @return \Duitku\V2\Model\Api\Jeniuspay\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Jeniuspay\Payment
     */
    ...
    /**
     * Create the jeniuspay payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Jeniuspay\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_jeniuspay/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Jeniuspay\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the jeniuspay Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the jeniuspay Decline action
     *
     * @return string
     */
