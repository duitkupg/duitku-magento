...
{
    const METHOD_CODE = 'duitku_linkajaapps';
    const METHOD_REFERENCE = 'duitkuLinkajaappsReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Linkajaapps\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get linkajaapps Auth object
     *
     * @return \Duitku\V2\Model\Api\Linkajaapps\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Linkajaapps\Payment
     */
    ...
    /**
     * Create the linkajaapps payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Linkajaapps\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajaapps/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Linkajaapps\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the linkajaapps Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the linkajaapps Decline action
     *
     * @return string
     */
