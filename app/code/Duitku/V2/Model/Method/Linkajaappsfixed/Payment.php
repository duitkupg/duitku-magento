...
{
    const METHOD_CODE = 'duitku_linkajaappsfixed';
    const METHOD_REFERENCE = 'duitkuLinkajaappsfixedReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Linkajaappsfixed\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get linkajaappsfixed Auth object
     *
     * @return \Duitku\V2\Model\Api\Linkajaappsfixed\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Linkajaappsfixed\Payment
     */
    ...
    /**
     * Create the linkajaappsfixed payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Linkajaappsfixed\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajaappsfixed/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Linkajaappsfixed\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the linkajaappsfixed Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the linkajaappsfixed Decline action
     *
     * @return string
     */
