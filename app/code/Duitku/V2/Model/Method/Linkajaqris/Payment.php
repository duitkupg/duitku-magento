...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Linkajaqris\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get linkajaqris Auth object
     *
     * @return \Duitku\V2\Model\Api\Linkajaqris\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Linkajaqris\Payment
     */
    ...
    /**
     * Create the linkajaqris payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Linkajaqris\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_linkajaqris/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Linkajaqris\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the linkajaqris Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the linkajaqris Decline action
     *
     * @return string
     */
