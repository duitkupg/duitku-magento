...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Mg\Request\Models\Auth
     */
    protected $_auth;
     ...
     * Get mg Auth object
     *
     * @return \Duitku\V2\Model\Api\Mg\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Mg\Payment
     */
    ...
    /**
     * Create the mg payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Mg\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_mg/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Mg\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the mg Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the mg Decline action
     *
     * @return string
     */
