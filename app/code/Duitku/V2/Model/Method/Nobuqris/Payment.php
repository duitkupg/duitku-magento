...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Nobuqris\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get nobuqris Auth object
     *
     * @return \Duitku\V2\Model\Api\Nobuqris\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Nobuqris\Payment
     */
    ...
    /**
     * Create the nobuqris payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Nobuqris\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_nobuqris/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Nobuqris\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the nobuqris Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the nobuqris Decline action
     *
     * @return string
     */
