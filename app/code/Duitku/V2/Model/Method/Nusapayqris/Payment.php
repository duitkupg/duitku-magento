 ...
 *
 */
namespace Duitku\V2\Model\Method\Nusapayqris;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_nusapayqris';
    const METHOD_REFERENCE = 'duitkuNusapayqrisReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Nusapayqris\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get nusapayqris Auth object
     *
     * @return \Duitku\V2\Model\Api\Nusapayqris\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Nusapayqris\Payment
     */
    ...
    /**
     * Create the nusapayqris payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Nusapayqris\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_nusapayqris/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Nusapayqris\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the nusapayqris Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the nusapayqris Decline action
     *
     * @return string
     */
