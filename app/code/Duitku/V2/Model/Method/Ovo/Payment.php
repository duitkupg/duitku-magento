...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Ovo\Request\Models\Auth
     */
    protected $_auth;
     ...
     * Get ovo Auth object
     *
     * @return \Duitku\V2\Model\Api\Ovo\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Ovo\Payment
     */
    ...
    /**
     * Create the ovo payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Ovo\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_ovo/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Ovo\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the ovo Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the ovo Decline action
     *
     * @return string
     */
