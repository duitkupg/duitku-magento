...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Pospay\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get pospay Auth object
     *
     * @return \Duitku\V2\Model\Api\Pospay\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Pospay\Payment
     */
    ...
    /**
     * Create the pospay payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Pospay\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_pospay/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Pospay\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the pospay Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the pospay Decline action
     *
     * @return string
     */
