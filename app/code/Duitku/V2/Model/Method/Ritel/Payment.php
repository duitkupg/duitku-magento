 ...
 *
 */
namespace Duitku\V2\Model\Method\Ritel;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_ritel';
    const METHOD_REFERENCE = 'duitkuRitelReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Ritel\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get ritel Auth object
     *
     * @return \Duitku\V2\Model\Api\Ritel\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Ritel\Payment
     */
    ...
    /**
     * Create the ritel payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Ritel\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_ritel/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Ritel\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the ritel Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the ritel Decline action
     *
     * @return string
     */
