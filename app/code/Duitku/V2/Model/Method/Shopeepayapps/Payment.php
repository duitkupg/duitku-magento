...
{
    const METHOD_CODE = 'duitku_shopeepayapps';
    const METHOD_REFERENCE = 'duitkuShopeepayappsReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Shopeepayapps\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get shopeepayapps Auth object
     *
     * @return \Duitku\V2\Model\Api\Shopeepayapps\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Shopeepayapps\Payment
     */
    ...
    /**
     * Create the shopeepayapps payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Shopeepayapps\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_shopeepayapps/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Shopeepayapps\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the shopeepayapps Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the shopeepayapps Decline action
     *
     * @return string
     */
