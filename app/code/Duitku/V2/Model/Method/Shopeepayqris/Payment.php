 ...
 *
 */
namespace Duitku\V2\Model\Method\Shopeepayqris;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_shopeepayqris';
    const METHOD_REFERENCE = 'duitkuShopeepayqrisReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Shopeepayqris\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get shopeepayqris Auth object
     *
     * @return \Duitku\V2\Model\Api\Shopeepayqris\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Shopeepayqris\Payment
     */
    ...
    /**
     * Create the shopeepayqris payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Shopeepayqris\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_shopeepayqris/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Shopeepayqris\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the shopeepayqris Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the shopeepayqris Decline action
     *
     * @return string
     */
