 ...
 *
 */
namespace Duitku\V2\Model\Method\Tokopediacardpayment;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_tokopediacardpayment';
    const METHOD_REFERENCE = 'duitkuTokopediacardpaymentReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Tokopediacardpayment\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get Tokopediacardpayment Auth object
     *
     * @return \Duitku\V2\Model\Api\Tokopediacardpayment\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Tokopediacardpayment\Payment
     */
    ...
    /**
     * Create the Tokopediacardpayment payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Tokopediacardpayment\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_tokopediacardpayment/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Tokopediacardpayment\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the Tokopediacardpayment Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the Tokopediacardpayment Decline action
     *
     * @return string
     */
