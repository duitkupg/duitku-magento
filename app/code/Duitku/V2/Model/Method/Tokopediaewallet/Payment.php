 ...
 *
 */
namespace Duitku\V2\Model\Method\Tokopediaewallet;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_tokopediaewallet';
    const METHOD_REFERENCE = 'duitkuTokopediaewalletReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Tokopediaewallet\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get Tokopediaewallet Auth object
     *
     * @return \Duitku\V2\Model\Api\Tokopediaewallet\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Tokopediaewallet\Payment
     */
    ...
    /**
     * Create the Tokopediaewallet payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Tokopediaewallet\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_tokopediaewallet/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Tokopediaewallet\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the Tokopediaewallet Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the Tokopediaewallet Decline action
     *
     * @return string
     */
