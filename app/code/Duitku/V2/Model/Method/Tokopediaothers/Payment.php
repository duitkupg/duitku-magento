 ...
 *
 */
namespace Duitku\V2\Model\Method\Tokopediaothers;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_tokopediaothers';
    const METHOD_REFERENCE = 'duitkuTokopediaothersReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Tokopediaothers\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get Tokopediaothers Auth object
     *
     * @return \Duitku\V2\Model\Api\Tokopediaothers\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Tokopediaothers\Payment
     */
    ...
    /**
     * Create the Tokopediaothers payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Tokopediaothers\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_tokopediaothers/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Tokopediaothers\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the Tokopediaothers Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the Tokopediaothers Decline action
     *
     * @return string
     */
