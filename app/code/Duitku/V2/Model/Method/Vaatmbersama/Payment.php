 ...
 *
 */
namespace Duitku\V2\Model\Method\Vaatmbersama;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vaatmbersama';
    const METHOD_REFERENCE = 'duitkuVaatmbersamaReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vaatmbersama\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vaatmbersama Auth object
     *
     * @return \Duitku\V2\Model\Api\Vaatmbersama\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vaatmbersama\Payment
     */
    ...
    /**
     * Create the vaatmbersama payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vaatmbersama\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vaatmbersama/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vaatmbersama\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vaatmbersama Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vaatmbersama Decline action
     *
     * @return string
     */
