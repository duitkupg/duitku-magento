...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vabca\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vabca Auth object
     *
     * @return \Duitku\V2\Model\Api\Vabca\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vabca\Payment
     */
    ...
    /**
     * Create the vabca payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vabca\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vabca/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vabca\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vabca Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vabca Decline action
     *
     * @return string
     */
