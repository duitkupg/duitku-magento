...
class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vabni\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vabni Auth object
     *
     * @return \Duitku\V2\Model\Api\Vabni\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vabni\Payment
     */
    ...
    /**
     * Create the vabni payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vabni\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vabni/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vabni\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vabni Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vabni Decline action
     *
     * @return string
     */
