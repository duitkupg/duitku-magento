 ...
 *
 */
namespace Duitku\V2\Model\Method\Vabsi;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vabsi';
    const METHOD_REFERENCE = 'duitkuVabsiReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vabsi\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vabsi Auth object
     *
     * @return \Duitku\V2\Model\Api\Vabsi\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vabsi\Payment
     */
    ...
    /**
     * Create the vabsi payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vabsi\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vabsi/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vabsi\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vabsi Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vabsi Decline action
     *
     * @return string
     */
