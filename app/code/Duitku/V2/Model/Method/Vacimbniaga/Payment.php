...
{
    const METHOD_CODE = 'duitku_vacimbniaga';
    const METHOD_REFERENCE = 'duitkuVacimbniagaReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vacimbniaga\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vacimbniaga Auth object
     *
     * @return \Duitku\V2\Model\Api\Vacimbniaga\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vacimbniaga\Payment
     */
    ...
    /**
     * Create the vacimbniaga payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vacimbniaga\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vacimbniaga/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vacimbniaga\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vacimbniaga Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vacimbniaga Decline action
     *
     * @return string
     */
