 ...
 *
 */
namespace Duitku\V2\Model\Method\Vadanamon;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vadanamon';
    const METHOD_REFERENCE = 'duitkuVadanamonReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vadanamon\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vadanamon Auth object
     *
     * @return \Duitku\V2\Model\Api\Vadanamon\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vadanamon\Payment
     */
    ...
    /**
     * Create the vadanamon payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vadanamon\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vadanamon/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vadanamon\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vadanamon Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vadanamon Decline action
     *
     * @return string
     */
