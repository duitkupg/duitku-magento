 ...
 *
 */
namespace Duitku\V2\Model\Method\Vamandiri;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vamandiri';
    const METHOD_REFERENCE = 'duitkuVamandiriReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vamandiri\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vamandiri Auth object
     *
     * @return \Duitku\V2\Model\Api\Vamandiri\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vamandiri\Payment
     */
    ...
    /**
     * Create the vamandiri payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vamandiri\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vamandiri/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vamandiri\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vamandiri Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vamandiri Decline action
     *
     * @return string
     */
