 ...
 *
 */
namespace Duitku\V2\Model\Method\Vamaybank;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vamaybank';
    const METHOD_REFERENCE = 'duitkuVamaybankReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vamaybank\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vamaybank Auth object
     *
     * @return \Duitku\V2\Model\Api\Vamaybank\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vamaybank\Payment
     */
    ...
    /**
     * Create the vamaybank payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vamaybank\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vamaybank/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vamaybank\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vamaybank Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vamaybank Decline action
     *
     * @return string
     */
