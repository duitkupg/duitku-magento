 ...
 *
 */
namespace Duitku\V2\Model\Method\Vapermata;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vapermata';
    const METHOD_REFERENCE = 'duitkuVapermataReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vapermata\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vapermata Auth object
     *
     * @return \Duitku\V2\Model\Api\Vapermata\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vapermata\Payment
     */
    ...
    /**
     * Create the vapermata payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vapermata\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vapermata/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vapermata\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vapermata Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vapermata Decline action
     *
     * @return string
     */
