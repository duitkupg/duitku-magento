 ...
 *
 */
namespace Duitku\V2\Model\Method\Vasampoerna;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\V2\Helper\DuitkuConstants;

class Payment extends \Duitku\V2\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vasampoerna';
    const METHOD_REFERENCE = 'duitkuVasampoernaReference';
    ...
    /**
     * @var \Duitku\V2\Model\Api\Vasampoerna\Request\Models\Auth
     */
    protected $_auth;

    /**
     * Get vasampoerna Auth object
     *
     * @return \Duitku\V2\Model\Api\Vasampoerna\Request\Models\Auth
     */
     ...
     * @return \Duitku\V2\Model\Method\Vasampoerna\Payment
     */
    ...
    /**
     * Create the vasampoerna payment window Request url
     *
     * @param \Magento\Sales\Model\Order
     * @return \Duitku\V2\Model\Method\Vasampoerna\Payment
     */
    ...
    $paymentMethod = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vasampoerna/payment_method');
     ...
     * @return \Duitku\V2\Model\Api\Vasampoerna\Response\Models\TransactionInformationType|null
     */
    ...
    /**
     * Retrieve an url for the vasampoerna Checkout action
     *
     * @return string
     */
    ...
    /**
     * Retrieve an url for the vasampoerna Decline action
     *
     * @return string
     */
