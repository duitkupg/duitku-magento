 ...
 *
 */
namespace Duitku\Vaatmbersama\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Vaatmbersama\Helper\DuitkuConstants;

class Payment extends \Duitku\Vaatmbersama\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vaatmepay';
    const METHOD_REFERENCE = 'duitkuvaatmReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Vaatmbersama\Block\Info\View';
    ...
    /**
     * @var \Duitku\Vaatmbersama\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Vaatmbersama\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Vaatmbersama\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vaatmepay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
  	 $apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vaatmepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
    $amount = round($order->getBaseTotalDue());
    
    $objectManager = \Magento\Framework\App\ObjectManager::getInstance(); 
    $FormKey = $objectManager->get('Magento\Framework\Data\Form\FormKey');
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epayvaatm/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epayvaatm/accept');
     ...
     * @return \Duitku\Vaatmbersama\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvaatm/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvaatm/cancel', ['_secure' => $this->_request->isSecure()]);
    }
