 ...
 *
 */
namespace Duitku\Vabca\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Vabca\Helper\DuitkuConstants;

class Payment extends \Duitku\Vabca\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vabcaepay';
    const METHOD_REFERENCE = 'duitkuvabcaReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Vabca\Block\Info\View';
    ...
    /**
     * @var \Duitku\Vabca\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Vabca\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Vabca\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vabcaepay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
  	 $apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vabcaepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
     ...
     * @return \Duitku\Vabca\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvabca/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvabca/cancel', ['_secure' => $this->_request->isSecure()]);
    }
