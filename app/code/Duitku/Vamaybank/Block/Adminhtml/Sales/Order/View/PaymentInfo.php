 ...
 *
 */
namespace Duitku\Vamaybank\Block\Adminhtml\Sales\Order\View;
...
class PaymentInfo extends \Magento\Backend\Block\Template
{
    ...
    /**
     * @var \Duitku\Vamaybank\Helper\Data
     */
     ...
     * @param \Duitku\Vamaybank\Helper\Data $duitkuHelper
     * @param array $data
     */
    public function __construct(
        ...
        \Duitku\Vamaybank\Helper\Data $duitkuHelper,
        array $data = []
    ) {
    ...
    public function getTransactionData()
    {
       ...
       if ($paymentMethod === EpayPayment::METHOD_CODE) {
            /** @var \Duitku\Vamaybank\Model\Method\Epay\Payment */
     ...
     *
     * @param \Duitku\Vamaybank\Model\Api\Checkout\Response\Models\Transaction $transaction
     * @return string
     */
     ...
     *
     * @param \Duitku\Vamaybank\Model\Api\Epay\Response\Models\TransactionInformationType $transactionInformation
