 ...
 *
 */
namespace Duitku\Vamaybank\Controller\Epayvamay;
use Magento\Framework\Controller\ResultFactory;

class Checkout extends \Duitku\Vamaybank\Controller\AbstractActionController
{
    /**
     * Checkout Action
     */
    public function execute()
    {
    	 ...
    	 $paymentmode = $this->_scopeConfig->getValue('payment/duitku_vamayepay/payment_mode', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
    	 if($paymentmode =='1')
    	 {
        ...
        $helper = $obj->get('Duitku\Vamaybank\Helper\Data');
