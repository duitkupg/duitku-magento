 ...
 *
 */
namespace Duitku\Vamaybank\Model\Method\Epay;
use \Magento\Sales\Model\Order\Payment\Transaction;
use \Duitku\Vamaybank\Helper\DuitkuConstants;

class Payment extends \Duitku\Vamaybank\Model\Method\AbstractPayment
{
    const METHOD_CODE = 'duitku_vamayepay';
    const METHOD_REFERENCE = 'duitkuvamayReference';

    protected $_code = self::METHOD_CODE;

    protected $_infoBlockType = 'Duitku\Vamaybank\Block\Info\View';
    ...
    /**
     * @var \Duitku\Vamaybank\Model\Api\Epay\Request\Models\Auth
     */
    protected $_auth;
     ...
     *
     * @return \Duitku\Vamaybank\Model\Api\Epay\Request\Models\Auth
     */
     ...
     * @return \Duitku\Vamaybank\Model\Api\Epay\Request\Payment
     */
    ...
    $obj = \Magento\Framework\App\ObjectManager::getInstance();
   	...
   	$merchantcode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vamayepay/merchantnumber',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
  	 $apikey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vamayepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
    $amount = round($order->getBaseTotalDue());
    
    $objectManager = \Magento\Framework\App\ObjectManager::getInstance(); 
    $FormKey = $objectManager->get('Magento\Framework\Data\Form\FormKey');
    $callbackUrl = $this->_urlBuilder->getUrl('duitku/epayvamay/callback?isAjax=true&form_key='.$FormKey->getFormKey());
    $returnUrl = $this->_urlBuilder->getUrl('duitku/epayvamay/accept');
     ...
     * @return \Duitku\Vamaybank\Model\Api\Epay\Response\Models\TransactionInformationType|null
     */
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvamay/checkout', ['_secure' => $this->_request->isSecure()]);
    }
    ...
    {
        return $this->_urlBuilder->getUrl('duitku/epayvamay/cancel', ['_secure' => $this->_request->isSecure()]);
    }
