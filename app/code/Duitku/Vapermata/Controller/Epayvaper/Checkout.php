...
class Checkout extends \Duitku\Vapermata\Controller\AbstractActionController
{
    /**
     * Checkout Action
     */
    public function execute()
    {
    	 $obj = \Magento\Framework\App\ObjectManager::getInstance();
    	  ...
    	  $paymentmode = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_vaperepay/payment_mode');
    	 if($paymentmode =='1')
    	 {
        ...
        $helper = $obj->get('Duitku\Vapermata\Helper\Data');
