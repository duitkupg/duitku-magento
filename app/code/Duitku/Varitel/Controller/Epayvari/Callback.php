...
class Callback extends \Duitku\Varitel\Controller\AbstractActionController
{
    ...
    public function validateCallback($posted, &$order, &$message)
    {
        ...
        if (!isset($payment)) {
	     ...
	     $obj = \Magento\Framework\App\ObjectManager::getInstance();
  	     $apiKey = $obj->get('Magento\Framework\App\Config\ScopeConfigInterface')->getValue('payment/duitku_variepay/api_key',\Magento\Store\Model\ScopeInterface::SCOPE_STORE, $order->getStoreId());
