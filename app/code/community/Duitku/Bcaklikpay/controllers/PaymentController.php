...
/**
 * Duitku BCA klikpay Payment controller
 *
 * @category   Mage
 * @package    Duitku_Bcaklikpay_PaymentController
...
class Duitku_Bcaklikpay_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('bcaklikpay/bcaklikpay');
        ...
        // Prepare Parameters
		 $params = array(
             ...
             'callbackUrl' => $baseUrl . 'bcaklikpay/payment/notify',
             'returnUrl' => $baseUrl . 'bcaklikpay/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('bcaklikpay/bcaklikpay')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
