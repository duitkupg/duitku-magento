...
/**
 * Duitku CIMB Click Payment controller
 *
 * @category   Mage
 * @package    Duitku_Cimbclick_PaymentController
...
class Duitku_Cimbclick_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('cimbclick/cimbclick');
        ...
        // Prepare Parameters
         $params = array(
             ...
             'callbackUrl' => $baseUrl . 'cimbclick/payment/notify',
             'returnUrl' => $baseUrl . 'cimbclick/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('cimbclick/cimbclick')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
