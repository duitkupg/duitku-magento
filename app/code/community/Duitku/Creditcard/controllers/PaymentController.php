...
/**
 * Duitku Credit Card Payment controller
 *
 * @category   Mage
 * @package    Duitku_Creditcard_PaymentController
...
class Duitku_Creditcard_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('creditcard/creditcard');
		...
		$phoneNumber = $order_billing_address->getTelephone();
        ...
        // Prepare Parameters
		 $params = array(
             ...
             'callbackUrl' => $baseUrl . 'creditcard/payment/notify',
             'returnUrl' => $baseUrl . 'creditcard/payment/return',
             'signature' => $signature,
			 'expiryPeriod' => 1440,
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('creditcard/creditcard')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
