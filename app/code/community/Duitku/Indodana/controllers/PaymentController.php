 ...
 *
 * @category   Mage
 * @package    Duitku_Indodana_PaymentController
...
class Duitku_Indodana_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('indodana/indodana');
        ...
        // Prepare Parameters
		 $params = array(
			 ...
			 'email' => $email,
             'callbackUrl' => $baseUrl . 'indodana/payment/notify',
             'returnUrl' => $baseUrl . 'indodana/payment/return',
             'signature' => $signature,
			 'expiryPeriod' => 1440,
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('indodana/indodana')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
