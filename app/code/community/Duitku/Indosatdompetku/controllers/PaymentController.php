...
/**
 * Duitku Indosat dompetku Payment controller
 *
 * @category   Mage
 * @package    Duitku_Indosatdompetku_PaymentController
...
class Duitku_Indosatdompetku_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('indosatdompetku/indosatdompetku');
        ...
        // Prepare Parameters
         $params = array(
             ...
             'callbackUrl' => $baseUrl . 'indosatdompetku/payment/notify',
             'returnUrl' => $baseUrl . 'indosatdompetku/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('indosatdompetku/indosatdompetku')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
