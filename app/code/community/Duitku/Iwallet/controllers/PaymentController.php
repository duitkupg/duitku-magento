...
/**
 * Duitku Wallet Payment controller
 *
 * @category   Mage
 * @package    Duitku_Iwallet_PaymentController
...
class Duitku_Iwallet_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('iwallet/iwallet');        
        ...
        // Prepare Parameters
         $params = array(
             ...
             'callbackUrl' => $baseUrl . 'iwallet/payment/notify',
             'returnUrl' => $baseUrl . 'iwallet/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('iwallet/iwallet')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
