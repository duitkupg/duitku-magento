 ...
 *
 * @category   Mage
 * @package    Duitku_Ovo_PaymentController
...
class Duitku_Ovo_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('ovo/ovo');
        ...
        // Prepare Parameters
		 $params = array(
             ...
             'callbackUrl' => $baseUrl . 'ovo/payment/notify',
             'returnUrl' => $baseUrl . 'ovo/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('ovo/ovo')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
