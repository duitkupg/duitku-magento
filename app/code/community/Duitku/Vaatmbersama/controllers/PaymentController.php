 ...
 *
 * @category   Mage
 * @package    Duitku_Vaatmbersama_PaymentController
...
class Duitku_Vaatmbersama_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('vaatmbersama/vaatmbersama');
        ...
        // Prepare Parameters
		 $params = array(
			 ...
			 'email' => $email,
             'callbackUrl' => $baseUrl . 'vaatmbersama/payment/notify',
             'returnUrl' => $baseUrl . 'vaatmbersama/payment/return',
             'signature' => $signature,
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('vaatmbersama/vaatmbersama')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
