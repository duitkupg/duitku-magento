 ...
 *
 * @category   Mage
 * @package    Duitku_Vabca_PaymentController
...
class Duitku_Vabca_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('vabca/vabca');
        ...
        // Prepare Parameters
		 $params = array(
			 ...
			 'email' => $email,
             'callbackUrl' => $baseUrl . 'vabca/payment/notify',
             'returnUrl' => $baseUrl . 'vabca/payment/return',
             'signature' => $signature,
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('vabca/vabca')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
