 ...
 *
 * @category   Mage
 * @package    Duitku_Vabni_PaymentController
...
class Duitku_Vabni_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('vabni/vabni');
        ...
        // Prepare Parameters
		 $params = array(
			 ...
			 'email' => $email,
             'callbackUrl' => $baseUrl . 'vabni/payment/notify',
             'returnUrl' => $baseUrl . 'vabni/payment/return',
             'signature' => $signature,
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('vabni/vabni')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
