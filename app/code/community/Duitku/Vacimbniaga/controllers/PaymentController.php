 ...
 *
 * @category   Mage
 * @package    Duitku_Vacimbniaga_PaymentController
...
class Duitku_Vacimbniaga_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('vacimbniaga/vacimbniaga');
        ...
        // Prepare Parameters
		 $params = array(
             ...
             'callbackUrl' => $baseUrl . 'vacimbniaga/payment/notify',
             'returnUrl' => $baseUrl . 'vacimbniaga/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('vacimbniaga/vacimbniaga')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
