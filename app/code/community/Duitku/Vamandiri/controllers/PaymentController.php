 ...
 *
 * @category   Mage
 * @package    Duitku_Vamandiri_PaymentController
...
class Duitku_Vamandiri_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('vamandiri/vamandiri');
        ...
        // Prepare Parameters
		 $params = array(
             ...
             'callbackUrl' => $baseUrl . 'vamandiri/payment/notify',
             'returnUrl' => $baseUrl . 'vamandiri/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('vamandiri/vamandiri')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
