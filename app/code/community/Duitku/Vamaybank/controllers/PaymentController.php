 ...
 *
 * @category   Mage
 * @package    Duitku_Vamaybank_PaymentController
...
class Duitku_Vamaybank_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('vamaybank/vamaybank');
        ...
        // Prepare Parameters
		 $params = array(
			 ...
			 'email' => $email,
             'callbackUrl' => $baseUrl . 'vamaybank/payment/notify',
             'returnUrl' => $baseUrl . 'vamaybank/payment/return',
             'signature' => $signature,
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('vamaybank/vamaybank')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
