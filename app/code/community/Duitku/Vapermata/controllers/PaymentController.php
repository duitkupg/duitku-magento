 ...
 *
 * @category   Mage
 * @package    Duitku_Vapermata_PaymentController
...
class Duitku_Vapermata_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('vapermata/vapermata');
        ...
        // Prepare Parameters
		 $params = array(
             ...
             'callbackUrl' => $baseUrl . 'vapermata/payment/notify',
             'returnUrl' => $baseUrl . 'vapermata/payment/return',
             'signature' => $signature,
         );
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('vapermata/vapermata')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
