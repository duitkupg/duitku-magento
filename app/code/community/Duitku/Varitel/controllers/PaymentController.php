 ...
 *
 * @category   Mage
 * @package    Duitku_Varitel_PaymentController
...
class Duitku_Varitel_PaymentController extends Mage_Core_Controller_Front_Action {

    public function processAction() {
        $model = Mage::getModel('varitel/varitel');
        ...
        // Prepare Parameters
		 $params = array(
			 ...
			 'email' => $email,
             'callbackUrl' => $baseUrl . 'Varitel/payment/notify',
             'returnUrl' => $baseUrl . 'Varitel/payment/return',
             'signature' => $signature,
    ...
    */
    ...
    public function returnAction() {
        $order_id = Mage::getModel('Varitel/Varitel')->getCheckout()->getLastRealOrderId();
        $order = Mage::getModel('sales/order')->loadByIncrementId($order_id);
